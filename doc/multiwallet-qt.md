...
In order to support loading of multiple wallets in bdcashprotocol-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bdcashprotocol.cpp.
...
Changes to bdcashprotocol.cpp
----------------------
bdcashprotocol.cpp is the entry point into bdcashprotocol-qt, and as such, will require some minor modifications to provide hooks for
