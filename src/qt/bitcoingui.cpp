                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BDCashProtocol") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BDCashProtocol address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bdcashprotocol: URIs)"));
    ...
    privacyAction = new QAction(QIcon(":/icons/privacy"), tr("&WEBSITE"), this);
    privacyAction->setStatusTip(tr("Access the site and get all the information about BDCash Protocol"));
    privacyAction->setToolTip(privacyAction->statusTip());
    privacyAction->setCheckable(true);
    //privacyAction->setVisible(false);
#ifdef Q_OS_MAC
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BDCashProtocol"), this);
    aboutAction->setStatusTip(tr("Show information about BDCashProtocol"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BDCashProtocol"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BDCashProtocol addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BDCashProtocol addresses"));
    ...
    openAction->setStatusTip(tr("Open a BDCashProtocol: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gentaium Core help message to get a list with possible BDCashProtocol command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BDCashProtocol client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BDCashProtocol network", "", count));
}
...
{
    QString strTitle = tr("BDCashProtocol"); // default title
    ...
    // Append title to "BDCashProtocol - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
