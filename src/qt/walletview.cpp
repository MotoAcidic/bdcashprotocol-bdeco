...
{   
    ...
    labelOverviewHeaderRight->setMinimumSize(QSize(250, 55));
    labelOverviewHeaderRight->setMaximumSize(QSize(250, 55));
    ...
    transactionView->setObjectName(QStringLiteral("tableTransactionHistory"));
