...
/** Utility functions used by the BDCashProtocol Qt UI.
 */
namespace GUIUtil
{
...
// Render BDCashProtocol addresses in monospace font
...
// Parse "bdcashprotocol:" URI into recipient object, return true on successful parsing
