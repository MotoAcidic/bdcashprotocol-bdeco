...
// Copyright (c) 2015-2018 The BDCashProtocol developers
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBDECOPathCustom = GetArg("-zbdecobackuppath", "");
    ...
    if(!strzBDECOPathCustom.empty()) {
        ui->wallet_customzbdecobackuppath->setText(QString::fromStdString(strzBDECOPathCustom));
        ui->wallet_customzbdecobackuppath_label->setVisible(true);
        ui->wallet_customzbdecobackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBDECOPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BDCashProtocol RPC console.") + "<br>" +
