...
#ifndef BDCashProtocol_ZBDECOTRACKER_H
#define BDCashProtocol_ZBDECOTRACKER_H
...
public:
    CzBDECOTracker(std::string strWalletFile);
    ~CzBDECOTracker();
...
#endif //BDCashProtocol_ZBDECOTRACKER_H
