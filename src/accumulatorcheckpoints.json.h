...
#ifndef BDCashProtocol_ACCUMULATORCHECKPOINTS_JSON_H
#define BDCashProtocol_ACCUMULATORCHECKPOINTS_JSON_H
...
#endif //BDCashProtocol_ACCUMULATORCHECKPOINTS_JSON_H
