...
/**
 * BDCashProtocol RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzbdecoseed(const UniValue& params, bool fHelp);
extern UniValue getzbdecoseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbdeco(const UniValue& params, bool fHelp);
extern UniValue dzbdecostate(const UniValue& params, bool fHelp);
