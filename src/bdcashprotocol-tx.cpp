...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BDCashProtocol bdcashprotocol-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bdcashprotocol-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bdcashprotocol transaction") + "\n" +
                               "  bdcashprotocol-tx [options] -create [commands]   " + _("Create hex-encoded bdcashprotocol transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bdcashprotocol transaction
