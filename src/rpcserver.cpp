...
CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 14190000.0)
...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BDCashProtocol server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BDCashProtocol server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BDCashProtocol features */
        {"bdcashprotocol", "masternode", &masternode, true, true, false},
        {"bdcashprotocol", "listmasternodes", &listmasternodes, true, true, false},
        {"bdcashprotocol", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bdcashprotocol", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bdcashprotocol", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bdcashprotocol", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bdcashprotocol", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bdcashprotocol", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bdcashprotocol", "masternodedebug", &masternodedebug, true, true, false},
        {"bdcashprotocol", "startmasternode", &startmasternode, true, true, false},
        {"bdcashprotocol", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bdcashprotocol", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bdcashprotocol", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bdcashprotocol", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bdcashprotocol", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bdcashprotocol", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bdcashprotocol", "mnbudget", &mnbudget, true, true, false},
        {"bdcashprotocol", "preparebudget", &preparebudget, true, true, false},
        {"bdcashprotocol", "submitbudget", &submitbudget, true, true, false},
        {"bdcashprotocol", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bdcashprotocol", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bdcashprotocol", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bdcashprotocol", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bdcashprotocol", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bdcashprotocol", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bdcashprotocol", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bdcashprotocol", "checkbudgets", &checkbudgets, true, true, false},
        {"bdcashprotocol", "mnsync", &mnsync, true, true, false},
        {"bdcashprotocol", "spork", &spork, true, true, false},
        {"bdcashprotocol", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbdecoseed", &getzbdecoseed, false, false, true},
        {"zerocoin", "setzbdecoseed", &setzbdecoseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbdeco", &searchdzbdeco, false, false, true},
        {"zerocoin", "dzbdecostate", &dzbdecostate, false, false, true}
...
{
    return "> bdcashprotocol-cli " + methodname + " " + args + "\n";
}
