...
#ifndef BDCashProtocol_ZBDECOWALLET_H
#define BDCashProtocol_ZBDECOWALLET_H
...
public:
    CzBDECOWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBDECO(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBDECO(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //BDCashProtocol_ZBDECOWALLET_H
