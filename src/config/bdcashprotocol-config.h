/* src/config/bdcashprotocol-config.h.  Generated from bdcashprotocol-config.h.in by configure.  */
/* src/config/bdcashprotocol-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BDECO_CONFIG_H

#define BDECO_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.bdcashprotocol.cash"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BDCashProtocol"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BDCashProtocol 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bdcashprotocol"
