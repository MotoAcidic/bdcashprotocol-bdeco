Contributing to BDCashProtocol
============================

The BDCashProtocol project operates an open contributor model where anyone is
...
The following applies to code changes to the BDCashProtocol project, and is not to be
confused with overall BDCashProtocol Network Protocol consensus changes.

Whether a pull request is merged into BDCashProtocol rests with the project merge
...
Patches that change BDCashProtocol consensus rules are considerably more involved than
...
Where a patch set proposes to change the BDCashProtocol consensus, it must have been
...
The project leader is the release manager for each BDCashProtocol release.
